...
17 benchmark references. Verified native setups are reconstructed individually
from the primary sources; entries without a completed setup remain research-only.
