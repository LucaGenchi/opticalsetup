...
<div class="preview"><iframe title="${esc(pretty(paper.id))} native OpticalSetup preview" src="/sketch/?paper=${esc(paper.id)}&amp;embed=1" loading="lazy" tabindex="-1" aria-hidden="true"></iframe></div><p class="caption">Live native trace. Open the editable setup to inspect components, change controls and save your copy.</p>` : `<div class="summary"><strong>Research notes · native setup pending</strong><p>${paper.status === 'reviewed' ? 'The source review below is preserved for an individual reconstruction.' : 'Full apparatus evidence is incomplete. Bibliographic records and abstracts do not establish the complete optical train.'}</p></div>`;
