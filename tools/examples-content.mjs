...
export const exampleEntries = [
  ...
  },
  {
    ...
    limitations: `<p>The crystal gates mixing on arrival time and nothing else. There is no
      ...
      same range, as they do on a bench, rather than a calculated efficiency — and no
      conversion fraction here can exceed 60 %, since no single pass converts everything.
