...
export const exampleEntries = [
  ...
  },
  {
    ...
    inOpticalSetupHtml: `
      ...
      wavelength of delay did. Set its drive to <em>Sine</em> and press play and
      the output modulates in time — a Mach–Zehnder modulator, which is what
      almost all high-speed optical telecommunications runs on.</p>
