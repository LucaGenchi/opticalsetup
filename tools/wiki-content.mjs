  ...
  },
  {
    ...
    realWorld: {
      ...
      html4: `
        ...
        <p>A bulk crystal or glass does the same with a focused femtosecond beam: above the critical power for self-focusing the beam collapses into a filament, and self-phase modulation in it broadens the spectrum${cite(19)}. Where the spectrum ends depends on the medium, the pump wavelength and the conditions. Multiphoton absorption and plasma clamp the filament's intensity, and the higher the order of that absorption, set by the bandgap over the photon energy, the higher the clamped intensity and the broader the spectrum, so wide-bandgap media reach furthest into the blue; the blue cut-off is also constrained by the material's dispersion. Once the beam breaks up into several filaments, more energy adds no further broadening; chirping the input or moving its focus tunes the blue cut-off, while a low numerical aperture and a longer medium extend the red side, which also grows with the pump wavelength${cite(19)}. Pumped near 800 nm, sapphire typically spans about 410–1100 nm, YAG about 420–1600 nm, fused silica about 390–1000 nm and CaF₂ about 300–2000 nm; with 1.1–1.6 µm pumping YAG's blue cut-off holds near 530 nm while its infrared side keeps extending${cite(19)}. The near-infrared half is useful in its own right: a 10 mm YAG plate pumped at 1035 nm has provided a 1050–1300 nm Stokes band for multiplex CARS microscopy${cite(20)}.</p>`,
      html5: `
