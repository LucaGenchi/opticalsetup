...

  {
    ...
    inOpticalSetup: {
      ...
      limitations: `<p>This is a 2D meridional section of a rotationally symmetric lens, so
        ...
        therefore describe the paraxial limit and say nothing about the aberration the rest of
        the surface produces — which is the interesting part, and is why the ray trace rather
        than the readout is the thing to look at.</p>
