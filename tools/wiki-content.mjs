  ...
  },
  {
    ...
    inOpticalSetup: {
      ...
      limitations: `<p>No scan is simulated. The trace is drawn from the arriving duration
        ...
        other, because a single instrument sees the sum of what reaches its face rather than
        two arms it could delay against one another. Finding time zero between two beams, as
        described above, is therefore something the component describes but does not
        perform.</p>`,
    },
