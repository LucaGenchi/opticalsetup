  ...
  },
  {
    ...
    realWorld: {
      ...
      html2: `
        ...
        <p>For the bulk electric-dipole response, χ⁽²⁾ vanishes in any inversion-symmetric medium — an unbiased isotropic gas, liquid or glass, or a centrosymmetric crystal — so second-order processes need a material without inversion symmetry. The rule concerns the bulk: surfaces and interfaces break the symmetry, which is why SHG also serves as a diagnostic of surface properties${cite(3)}, and applied fields and higher-multipole contributions lie outside it as well. χ⁽³⁾ is symmetry-allowed in centrosymmetric media as well${cite(1)}. The main processes are:</p>
        <ul>
