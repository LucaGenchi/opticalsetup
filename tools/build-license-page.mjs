...
<main>
  ...
  <p>Parts of the site are other people's work under their own terms: the wiki's formula
    rendering ships <a href="https://katex.org/">KaTeX</a> (MIT), and community setups stay
    their authors' under the terms each submission recorded. See
    <a href="https://github.com/LucaGenchi/opticalsetup/blob/main/THIRD-PARTY-NOTICES.md">THIRD-PARTY-NOTICES.md</a>.</p>
