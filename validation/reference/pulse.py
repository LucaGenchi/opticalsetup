...
MODEL = {
    ...
    "convergence": "16384-point grids over a 64-pulse-width window. Refining the grid changes nothing measurable; the window is what matters, since a sech^2 envelope's wings leave it slowly. Measured below.",
