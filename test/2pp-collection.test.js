...
test('paper identities and source files have explicit provenance and unresolved values',async()=>{
 ...
 assert.match(page,/Download native scene/);
 assert.equal(collectionSetupRequest(new URLSearchParams('paper=dong-2007')).path, '../collections/2pp/setups/dong-2007.json');
