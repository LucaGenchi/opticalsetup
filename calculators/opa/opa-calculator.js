...
// parameter table explains each one at length. `arrowStep` is the increment
// of the field's arrows (absent: 1); typed values need not be multiples.
export const OPA_INPUTS = [
  { id: 'pumpWl', group: 'pump', label: 'Wavelength', symbol: 'λ<sub>p</sub>', unit: 'nm', value: 515, arrowStep: 5, min: 200, max: 5000,
    help: 'Vacuum wavelength of the pump. It must be the shortest of the three waves.' },
  { id: 'pumpPowerW', group: 'pump', label: 'Average power', symbol: 'P<sub>p</sub>', unit: 'W', value: 1, min: 0, max: 1e5,
    help: 'Average pump power reaching the crystal. It sets the energy budget, not the gain.' },
  { id: 'pumpIntensityGWcm2', group: 'pump', label: 'Peak intensity', symbol: 'I<sub>p</sub>', unit: 'GW/cm²', value: 50, min: 0, max: 1000,
  ...
  { id: 'pumpFwhmFs', group: 'pump', label: 'Pulse duration (FWHM)', symbol: 'τ<sub>p</sub>', unit: 'fs', value: 300, arrowStep: 50, min: 1, max: 1e7,
    help: 'Full width at half maximum of the pump intensity envelope (Gaussian).', when: 'pumpPulsed' },
  { id: 'repRateMHz', group: 'pump', label: 'Repetition rate', symbol: 'f<sub>rep</sub>', unit: 'MHz', value: 0.2, arrowStep: 0.1, min: 1e-6, max: 1e4,
    help: 'Pulse repetition rate, shared by pump and seed.' },
  { id: 'dEffPmV', group: 'crystal', label: 'Effective nonlinearity', symbol: 'd<sub>eff</sub>', unit: 'pm/V', value: 2, min: 0, max: 100,
    help: 'Strength of the crystal’s χ⁽²⁾ response for this polarization and direction. See “d_eff” below.' },
  { id: 'nPump', group: 'crystal', label: 'Refractive index at λp', symbol: 'n<sub>p</sub>', value: 1.67, arrowStep: 0.01, min: 1, max: 5,
    help: 'Refractive index of the crystal for the pump, in its polarization.' },
  { id: 'nSignal', group: 'crystal', label: 'Refractive index at λs', symbol: 'n<sub>s</sub>', value: 1.66, arrowStep: 0.01, min: 1, max: 5,
    help: 'Refractive index for the signal (seed).' },
  { id: 'nIdler', group: 'crystal', label: 'Refractive index at λi', symbol: 'n<sub>i</sub>', value: 1.64, arrowStep: 0.01, min: 1, max: 5,
    help: 'Refractive index for the idler.' },
  { id: 'lengthMm', group: 'crystal', label: 'Crystal length', symbol: 'L', unit: 'mm', value: 2, min: 0, max: 100,
  ...
  { id: 'seedPowerW', group: 'seed', label: 'Average power', symbol: 'P<sub>s</sub>', unit: 'W', value: 1e-6, min: 0, max: 1e5,
  ...
  { id: 'seedFwhmFs', group: 'seed', label: 'Pulse duration (FWHM)', symbol: 'τ<sub>s</sub>', unit: 'fs', value: 300, arrowStep: 50, min: 1, max: 1e7,
    help: 'FWHM of the seed intensity envelope (Gaussian).', when: 'seedPulsed' },
  { id: 'delayFs', group: 'seed', label: 'Delay after the pump', symbol: 'Δt', unit: 'fs', value: 0, min: -1e7, max: 1e7,
  ...
  { id: 'seed2Wl', group: 'seed2', label: 'Wavelength', symbol: 'λ<sub>s2</sub>', unit: 'nm', value: 900, arrowStep: 5, min: 200, max: 20000,
    help: 'Wavelength of the second seed.', when: 'seed2On' },
  { id: 'seed2DelayFs', group: 'seed2', label: 'Delay after the pump', symbol: 'Δt<sub>2</sub>', unit: 'fs', value: 0, min: -1e7, max: 1e7,
